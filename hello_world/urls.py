...
urlpatterns = [
    ...
    path("organizations/<slug:slug>/profile/", event_views.organization_public_profile, name="organization_public_profile"),
    path("organizations/<slug:slug>/", event_views.organization_dashboard, name="organization_dashboard"),
