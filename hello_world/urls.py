...
urlpatterns = [
    ...
    path("discover/", account_views.discover, name="discover"),
    path("nearby/", account_views.geo_discovery, name="geo_discovery"),
    ...
    path("organizations/dashboard/<slug:slug>/", event_views.organization_dashboard, name="organization_portal_dashboard"),
    path("organizations/dashboard/<slug:slug>/profile/edit/", event_views.organization_edit, name="organization_edit"),
    path("organizations/dashboard/<slug:slug>/locations/create/", event_views.organization_location_create, name="organization_portal_location_create"),
    ...
    path("organizations/<slug:slug>/locations/create/", event_views.organization_location_create, name="organization_location_create"),
    ...
    path("organizations/<slug:slug>/", event_views.organization_public_profile, name="organization_dashboard"),
