...
class Command(BaseCommand):
    ...
    def _upload_if_absent(self, name, source_path):
        """Upload a file only if it is not already present.

        Avoids HeadObject by attempting upload directly and catching
        conflict errors, or by doing a read-after-write verification.
        """
